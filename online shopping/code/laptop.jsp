...
if((Integer.parseInt(x) >= x1 ) && (Integer.parseInt(x) <=  x2 ) )
{
...
<tr><td></td></tr>
 <tr valign="top"><td align="center" class="id1">LAPTOP </td></tr> 
 <tr><td align="right"><img src="image/LAPTOP.JPG" width="60%" height="40%"></td></td></tr>
 <tr>
...
<p>&nbsp;</p><form action="insertrate.jsp" name="f1" method="post" onSubmit="return val()">
