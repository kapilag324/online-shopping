...
<table align="left"  bgcolor="#999999" width="30%" height="235">
<tr>
...
<form action="insertmsga.jsp" name="f1" method="post" onSubmit="return fun()">
<table align="center"  bgcolor="#CC0000" border="0" width="60%" height="284" >
  <tr>
  ...
  <tr>
    ...
    <td><textarea name="msg" rows="5" cols="44"></textarea></td>
  </tr>
  <tr>
    <td height="58"></td>
