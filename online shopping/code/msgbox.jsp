...
<table width="90%" height="500" border="1px" align="center" cellpadding="3" cellspacing="3" bgcolor="#CC0000" >
      ...
      <td colspan="12" align="center" class="id2" background="Images/bg_thead.gif">View Mail box &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
      ...
      <th width="162" class="id2" align="left"> From</th>
	  <th width="119" class="id2" align="left">Subject</th>
	  <th width="142" class="id2" align="left">Message</th>
	   <th width="103" class="id2" align="left">Reply</th>
	    <th width="106" class="id2" align="left">Delete</th>
...
<% 
	...
	try
	 {  
	   ...
	   stmt = con.prepareStatement("select * from adminmsgs");
...
<a href="reply.jsp?to=<%=to%>">
		 ...
		 %>
		     <a href="delmsg.jsp?code=<%=ecode%>"> Delete</a>
